<x-layouts.app title="Editar Cliente">
                                ...
                                <div class="w-full max-w-lg">
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6"
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <input
                                                ...
                                                id="cpf" name="cpf" type="text" value="{{ $Cliente->cpf }}"
                                                style="width: 100%;height: 35px;" disabled>
                                        </div>
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <input
                                                ...
                                                value="{{ $Cliente->name }}" style="width: 100%;height: 35px;">
                                        </div>
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6"
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <input
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                id="endereco" name="endereco" type="text" placeholder="Centro"
                                                value="{{ $Cliente->address }}" style="width: 100%;height: 35px;">
                                    ...
                                    <div style="text-align: right;">
                                        ...
                                        <button id="editClient"
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                            style="color: white;background: blue;">Salvar
                                        </button>

                                        <button id="apagarClient"
                                            onclick="apis.delete({{$Cliente->id}},true)"
                                            name="delete"
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                            style="color: white;background: rgb(255, 0, 0);">Deletar
                                        </button>
                                    </div>
                                </div>

                            </div>
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Edite o seu
                                cliente!</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function selecionarOpcaoPorValor(idSelect, valor) {
        ...
        selecionarOpcaoPorValor("estado", "{{ $Cliente->state }}")

        document.querySelector('input[type="date"]').value = formatData("{{ $Cliente->date_birth }}")
        ...
        function carregarCidades(isLoaded = false) {
            ...
            fetch(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${estadoId}/municipios`)
                ...
                .then(data => {
                    ...
                    data.forEach(cidade => {
                        ...
                        if (isLoaded && cidade.nome == "{{ $Cliente->city }}") {
