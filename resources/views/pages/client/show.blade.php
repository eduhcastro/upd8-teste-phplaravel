    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16" style="margin-top: 10px">
                ...
                <div class="grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <div
                        ...
                        <div>
                                ...
                                <div class="w-full max-w-lg">
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6"
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <label
                                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                                for="nome"
                                                style="margin-right: 10px;margin-top: 8px;">Nome</label>
                                       
                                                <input
                                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                    id="nome" type="text" placeholder="José Eduardo"
                                                    style="width: 100%;height: 35px;" name="response" />
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <input
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                id="nascimento" type="date" placeholder="Casa"
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <label
                                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                                for="grid-first-name"
                                                style="margin-right: 10px;margin-top: 8px;">Sexo</label>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6"
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <input
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                id="endereco" type="text" placeholder="Jane"
                                                style="width: 100%;height: 35px;">
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0"
                                            ...
                                            <select
                                                ...
                                                onchange="carregarCidades()" name="estado" id="estado">
                                    ...
                                    <div style="text-align: right;" id="botoes">
                                        <button
                                            ...
                                            style="color: white;background: blue;">Pesquisar
                                        </button>
                                        <button
                                            id="limpar"
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Lista completa de
                                todos os clientes!</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8" style="margin-top: 10px;">
                    <div
                        class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <table id="example" class="stripe hover"
                            style="width:100%;padding-top: 1em;text-align: left;padding-bottom: 1em;">
                            <thead>
                                <tr>
                                    ...
                                    <th data-priority="2">Data Nasc.</th>
                                    <th data-priority="3">Estado</th>
                                    <th data-priority="4">Cidade</th>
                                    ...
                                    <tr>
                                        <td style="width: 130px;">
                                            <button
                                                ...
                                                style="color: white;background: #00890c;width: 100px; font-size: 11px;"
                                                onclick="location.href = '{{ route('editClientsPage', ['id' => $client->id]) }}';">
                                                Modificar
                                            </button>
                                        </td>
                                        <td>
                                            <div>
                                                ...
                                                <button data-userid={{$client->id}}
                                                    onclick="apis.delete({{$client->id}})"
                                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded"
                                                    style="color: white;background: #bb0000;width: 100px; font-size: 11px;">
                                                    Deletar
                                                </button>
                                            </div>
                    ...
                    {{ $clients->links('components.pagination.tailwind') }}
